...
- **Gli Attacchi che si tirano** (*Random Attacks*, p. 176): la mischia li tira a ogni assalto, un dado per modello che mena, e la previsione conta la media — l'Hell Pit Abomination con «D6+1» mena da 2 a 7 attacchi, non più sei sempre. Resta al primo numero della riga la fila di un equipaggio o di una cavalcatura (i ratti «Rats only» della Doom-Wheel), che nessuna lista salvata schiera. La **Magic Resistance** si legge e non si sottrae: il tiro di lancio contro chi ce l'ha va corretto a mano.
