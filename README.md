...
- **I personaggi uniti menano.** Un capo dentro un reggimento non è un modello in più: è un profilo diverso nella stessa scatola, e per molto tempo i suoi colpi sparivano — entrava nella psicologia e nello stendardo, e basta. Adesso ogni personaggio è una squadra sua, con i suoi Attacchi, la sua Forza, la sua Abilità Combattimento e la sua Iniziativa, e mena quando tocca a lui: l'ordine non è più fra due contendenti ma fra tutte le squadre in campo, a gradini, e chi sta sullo stesso gradino mena insieme. In prima fila il personaggio **occupa un posto** invece di aggiungerne uno.
...
- Lo **scontro simulato** è una stima, non un arbitro. Conosce quello che sta nel profilo e i numeri che imposti a mano; non sa niente di oggetti magici e terrore. Le regole speciali che non applica non spariscono: restano in elenco, e dove la lista porta con sé il testo del manuale l'etichetta lo mostra per intero, così quella regola la applicate voi. Quanti modelli si toccano lo **conta sulle basette** quando le unità sono sul tavolo, e lo dichiara quando invece lo stima; quanti colpi porta l'urto della carica resta un ordine di grandezza. Il campo *Attacchi* è modificabile, e vale sulla truppa: i personaggi uniti hanno una riga loro.
- **A chi assegnare le ferite in arrivo** resta ai giocatori, ed è giusto così: un personaggio dentro un reggimento ha una Resistenza diversa da quella dei suoi, ma chi incassa il colpo lo sceglie chi possiede l'unità. Il pannello mostra i profili affiancati e non decide.
- Il **campo di tiro** disegnato guarda dal centro del fronte; il conto dei tiratori invece misura modello per modello. Le coperture le decide il tipo di elemento scenico — bosco leggera, rovine e muretti pesante — non il pezzo vero che hai in mano.
